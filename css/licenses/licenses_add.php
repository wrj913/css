...
<table width="776" border="1" align="center" cellpadding="0" cellspacing="0" class="tableBorder">
      <tr>
        <td height="22" >当前位置：读者管理 &gt; 读者档案管理 &gt; 添加读者信息 &gt;&gt;&gt;</td>
      </tr>
      <tr>
	<form name="form1" method="post" action="./licenses_ok.php ">
	<table width="600" height="432"  border="1" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr>
